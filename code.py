import re  # Importing the regular expression module for email validation
import sys
        ...
        for j in range(cols):        
            ...
            if j == 1:
                while True:
                    ...
                    # Verifying phone number has exactly 10 digits
                    if len(phone_number) != 10 or not phone_number.isdigit():
                        print("Invalid phone number. Please enter a 10-digit number.")
                    else:
                        temp.append(int(phone_number))
                        break
            ...
            if j == 3:
                while True:
                    ...
                    # Verifying date of birth format
                    dob_parts = dob.split('/')
                    if len(dob_parts) != 3:
